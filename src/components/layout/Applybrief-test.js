...
// winner
      ...
      let sortedSubmissions = [{image: {user: {full_name: ""}}}];
      console.log("let: ", sortedSubmissions[0].image.user);

      let promise = new Promise(function(resolve, reject) {
          sortedSubmissions = _this.state.gramventure.submissions.sort((a, b) => (b).total_votes - (a).total_votes);
          console.log("promise", sortedSubmissions);
          if (sortedSubmissions.length != 0)
              resolve(sortedSubmissions);
          else
            reject(Error("ca a foire"));

      });

      promise.then(function(result) {
        console.log(result);
        sortedSubmissions = result;
        console.log("Promise: ", sortedSubmissions[0].image.user.full_name);
...
<div className="cp-main-content tb-50">
      ...
      <div className="container">
        <div className="row"> 
          <div className="col-md-9">
            ...
            <h3>Congratulation to our grammaster {this.state.winner[0].image.user.full_name} for winning this Gramventure!</h3>
          </div>
    ...
    <ul>
      ...
      <ListElement submissions={this.sortedSubmissions} />
